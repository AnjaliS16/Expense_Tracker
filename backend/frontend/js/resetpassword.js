...
window.addEventListener('DOMContentLoaded', async () => {
    ...
    const res = await axios.get(`http://13.54.247.155:3000/check-password-link/${resetId}`)
    ...
    try {
      ...
      //  console.log(newPassword)
        ...
        if (newPassword !== confirmPassword)
            ...
            const res = await axios.post(`http://13.54.247.155:3000/resetpassword/${resetId}`, { newPassword, confirmPassword })
           // console.log(res)
